const answers = {
  1: `<div>Na samym początku chciałbym powiedzieć że bardzo się martwię. I w ogóle jestem introwertykiem, zrównoważony, a także jestem osobą flegmatyczną. Nie lubię dużo gadać więc na niektóre pytania mogę krótko odpowiedzieć.\n\nCóż mam na imię Artem, mam 17 lat i jestem młodym, ambitnym i wysportowanym chłopakiem.\nJestem osobą otwartą, spokojną, ambitną i optymistyczną.\nJeżeli mówić o wadach, cóż to od czasu do czasu bywam leniwy, szczególnie wieczorami, jak wszyscy inni w moim wieku.\n\nJestem Ukraińcem, urodziłem się na Ukrainie w mieście Czernichów. Studiowałem w liceum matematycznym i kiedy w połowie grudnia ubiegłego roku przeprowadziłem się do Polski, kontynuowałem naukę w szkole ukraińskiej online.\nTeraz mieszkam w Poznaniu z rodziną.\n\nJeśli mówimy o rodzinie to mam starszą siostrę, która ma 19 lat, młodszego brata, który ma 3 lata i kota.\nMoja siostra studiuje na uniwersytecie w Poznaniu.</div>`,
  2: `<div>Wybrałem Collegium Da Vinci, ponieważ moim zdaniem to najbardziej kreatywna i ciekawa uczelnia, która oferuje nowoczesne podejście do nauki i nowoczesne kształcenie specjalistów, którzy będą w przyszłości mogli pracować na rynku pracy</div>`,
  3: `<div>Wybrałem kierunek e-commerce, ponieważ lubię pracować w internecie i dobrze radzę sobie z komputerami. Chciałbym również nauczyć się sprzedawać produkty przez internet lub prowadzić własny sklep internetowy.\n\nDzisiaj ludzie kupują więcej rzeczy online niż w sklepach stacjonarnych, ponieważ jest to wygodniejsze. Myślę, że w przyszłości większość sklepów będzie działać online, dlatego chciałbym pracować w tej branży.</div>`,
  ...
  11: `<div>Następną rzeczą, o której chciałbym powiedzieć, to hobby.\nBardzo lubię czytać książki, najczęściej czytam kryminały, fantastyczne i książki przygodowe. Także często oglądam anime. Od czasu do czasu rysuję kiedy mam czas, ale to także zależy od mojego nastroju. Oprócz tego bardzo lubię uprawiasz sport. Uprawiam go 3 razy w tygodniu. Na dodatek interesuję się programowaniem i astronomią, ponieważ jest dla mnie ciekawa nauka.\nJeśli mówić o czasie wolnym, to w czasie wolnym zajmuję się swoimi hobby, na przykład ci tam lub słucham muzyki.</div>`, 
