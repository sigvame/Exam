const answers = {
    1: `<div>Mam na imię Artem, mam 17 lat. Urodziłem się na Ukrainie, w mieście Czernihów. W połowie grudnia przeprowadziłem się do Polski.\n\nMam dużą rodzinę. Mam starszą siostrę – ma 18 lat i studiuje w college’u w Poznaniu. Mam też młodszego brata, który ma dopiero 2 lata. Mamy również kota.\n\nNa Ukrainie uczyłem się w liceum matematycznym, które kończę w tym roku ze średnim wynikiem 9. Moimi ulubionymi przedmiotami były angielski i informatyka. Przez około siedem lat dodatkowo uczyłem się angielskiego. Od dwóch lat uczę się w Akademii IT Step na kierunku Programowanie.\n\nJestem osobą towarzyską i łatwo odnajduję się w nowym środowisku. Spokojnie radzę sobie w stresujących sytuacjach. Od ponad 10 lat uprawiam sport – chodziłem na różne sekcje sportowe, a przez ostatnie 4 lata regularnie ćwiczę na siłowni.\n\nW wolnym czasie odpoczywam, słucham muzyki, spaceruję, rysuję albo po prostu zajmuję się swoimi sprawami.</div>`,
